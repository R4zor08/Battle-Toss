    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-blue-900 to-purple-900 overflow-hidden">
      ...
      <div className="flex flex-col gap-6 w-full max-w-md px-4 z-10">
        ...
        <div className="grid grid-cols-2 gap-4 mt-2">
            <button
            onClick={() => onNavigate('characterGallery' as ScreenState)}
            ...
            <button
            onClick={() => onNavigate('mapGallery' as ScreenState)}
            className="bg-gray-800 text-white py-3 rounded-xl font-bold uppercase shadow-[0_4px_0_rgb(31,41,55)] hover:translate-y-1 hover:shadow-[0_2px_0_rgb(31,41,55)] active:translate-y-2 active:shadow-none transition-all">
...
export const MapGallery: React.FC<{
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center bg-gray-900 text-white p-6 overflow-y-auto">
      <div className="w-full flex justify-between items-center mb-8">
        ...
        <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 uppercase">
          MAPS
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full max-w-6xl">
        ...
        <div
          key={map.id}
          className="flex flex-col items-center p-2 rounded-2xl border-4 border-gray-700 overflow-hidden bg-gray-800">
            ...
            <span className="font-bold text-xl pb-2">{map.name}</span>
          </div>
        )}
      </div>
    </div>);
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center bg-gray-900 text-white p-6 overflow-y-auto">
      <div className="w-full flex justify-between items-center mb-8">
        ...
        <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500 uppercase">
          CHARACTERS
        </h2>
        <div className="w-20"></div>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-5xl">
        ...
        <div
          key={char.id}
          className="flex flex-col items-center p-4 rounded-2xl border-4 border-gray-700 bg-gray-800">
          
            <CharacterAvatar char={char} size={96} />
            <span className="font-bold text-lg text-center leading-tight mt-3">
              {char.name}
            </span>
